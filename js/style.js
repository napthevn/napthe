...
$(document).ready(function() {
    ...
    if (idGame) {
        ...
        $('.faifai').attr('href', 'choose-payment.html');
        $('.hd1').addClass('hide');
    ...
    $('#login').click(function() {
        ...
        if ($id.val().length === 0) {
            $(this).parents().find('.c-error').text('Vui lòng nhập ID người chơi');
        } else if ($id.val().length < 8) {
            $(this).parents().find('.c-error').text('ID người chơi không hợp lệ');
            ...
            sessionStorage.setItem('idGame', $id.val());
                        ...
                        if (json.status == "error") {
                            ...
                            $('.c-error').html(json.msg);
                                 ...
                                 setInterval(function() {
                                      $('.c-error').html(json.msg);
           $.post("check.php", {serial: $seri.val()}, function(result){
    if(result === '0'){
